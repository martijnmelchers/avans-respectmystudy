        ...
        <div class="col-12 box">
            ...
            <form method="post">
                ...
                <div class="buttons mt-1">
                    <input type="submit" name="submit" href="{{route('dashboard-minor-edit', $minor->id)}}"
            ...
            <div class="buttons">
                ...
                <a href="{{route('dashboard-minor-newversion', $minor->id)}}" class="button red small">Nieuwe versie
                    aanmaken</a>
