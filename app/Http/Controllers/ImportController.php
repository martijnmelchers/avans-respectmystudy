...
class ImportController extends Controller
{
    ...
    public function Themes()
    {
        ...
        curl_setopt($ch, CURLOPT_URL, "https://www.kiesopmaat.nl/api/public/choicetheme/$page");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
        ...
        foreach ($php_result->results as $r) {
            $organization = Theme::all()->where('id', $r->id)->first();
            ...
            if (isset($organization)) {
                ...
                $theme = new Theme([
                    "id" => $r->id,
                    "name" => $r->name,
                    "skd_Cluster_CD" => $r->skd_Cluster_CD,
                    "sector" => $r->sector,
                ]);
                $theme->save();
            }
